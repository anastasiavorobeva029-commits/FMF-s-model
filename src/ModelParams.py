...
class ModelParams:
    ...
    initial_population_size: int = 20_000
    ...
    def scenario_1():
        ...
        return ModelParams(ethnic_assortativity=0.85, do_diagnosing=True, use_screening=False,
                           screening_coverage=0, screening_efficiency=0, fertility_recovery=0.5,
                           ethnic_distribution={'Armenian': 0.9, 'Other': 0.1}, use_pgt=False, pgt_efficiency=0.0)
